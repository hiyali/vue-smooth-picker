...
/***/
function(t,e,n){"use strict";function r(t){return t&&t.__esModule?t:{default:t}}var o,i,a=n(1),s=r(a),c=n(5),u=r(c);n(6),o=n(11),i=r(o),s.default.use(u.default),console.warn("vue-smooth-picker version",c.version),new s.default(Object.assign({},i.default,{el:"#app"}))},/* 1 */
/***/
...
function z(t,e,n,r){var o=Object.create(t||null);return e?b(o,e):o}/**
	 ...
	 * Object-based format.
	 */
function q(t,e){var n,r,o,i,a,s=t.props;if(s){if(n={},Array.isArray(s))for(r=s.length;r--;)o=s[r],"string"==typeof o&&(i=Si(o),n[i]={type:null});else if(u(s))for(a in s)o=s[a],i=Si(a),n[i]=u(o)?o:{type:o};t.props=n}}/**
	 * Normalize all injections into Object-based format
	 */
function W(t,e){var n,r,o,i=t.inject,a=t.inject={};if(Array.isArray(i))for(n=0;n<i.length;n++)a[i[n]]={from:i[n]};else if(u(i))for(r in i)o=i[r],a[r]=u(o)?b({from:r},o):{from:o}}/**
...
// already pending
// () => Promise
return i(t.error)&&o(t.errorComp)?t.errorComp:o(t.resolved)?t.resolved:i(t.loading)&&o(t.loadingComp)?t.loadingComp:o(t.contexts)?void t.contexts.push(n):(a=t.contexts=[n],s=!0,u=function(){for(var t=0,e=a.length;t<e;t++)a[t].$forceUpdate()},l=I(function(n){
// cache resolved
t.resolved=mt(n,e),
// invoke callbacks only if this is not a synchronous resolve
// (async resolves are shimmed as synchronous during SSR)
s||u()}),f=I(function(e){o(t.errorComp)&&(t.error=!0,u())}),d=t(l,f),c(d)&&("function"==typeof d.then?r(t.resolved)&&d.then(l,f):o(d.component)&&"function"==typeof d.component.then&&(d.component.then(l,f),o(d.error)&&(t.errorComp=mt(d.error,e)),o(d.loading)&&(t.loadingComp=mt(d.loading,e),0===d.delay?t.loading=!0:setTimeout(function(){r(t.resolved)&&r(t.error)&&(t.loading=!0,u())},d.delay||200)),o(d.timeout)&&setTimeout(function(){r(t.resolved)&&f(null)},d.timeout))),s=!1,t.loading?t.loadingComp:t.resolved)}/*  */
...
var e=t.$options._parentListeners;e&&kt(t,e)}function Ct(t,e,n){n?Zr.$once(t,e):Zr.$on(t,e)}function wt(t,e){Zr.$off(t,e)}function kt(t,e,n){Zr=t,ct(e,n||{},Ct,wt,t)}function It(t){var e=/^hook:/;t.prototype.$on=function(t,n){var r,o,i=this,a=this;if(Array.isArray(t))for(r=0,o=t.length;r<o;r++)i.$on(t[r],n);else(a._events[t]||(a._events[t]=[])).push(n),
...
/**
	 ...
	 */
function At(t,e){var n,r,o,i,a,s,c,u={};if(!t)return u;for(n=[],r=0,o=t.length;r<o;r++)i=t[r],a=i.data,
...
// instantiation here.
n in t||zt(t,"_props",n)};for(r in e)n(r);Rr.shouldConvert=!0}function Yt(t){var e,n,r,o,i,a=t.$options.data;for(a=t._data="function"==typeof a?Xt(a,t):a||{},u(a)||(a={}),e=Object.keys(a),n=t.$options.props,r=t.$options.methods,o=e.length;o--;)i=e[o],n&&m(n,i)||A(i)||zt(t,"_data",i);
// observe data
...
function ge(t,e,n,r,o){var a,s,c,u=o.options;this.data=t,this.props=e,this.children=n,this.parent=r,this.listeners=t.on||Gi,this.injections=ie(u.inject,r),this.slots=function(){return At(n,r)},a=Object.create(r),s=i(u._compiled),c=!s,
// support for compiled functional template
s&&(
// exposing $options for renderStatic()
this.$options=u,
// pre-resolve slots for renderSlot()
this.$slots=this.slots(),this.$scopedSlots=t.scopedSlots||Gi),u._scopeId?this._c=function(t,e,n,o){var i=Ie(a,t,e,n,o,c);return i&&(i.functionalScopeId=u._scopeId,i.functionalContext=r),i}:this._c=function(t,e,n,r){return Ie(a,t,e,n,r,c)}}function ye(t,e,n,r,i){var a,s,c,u=t.options,l={},f=u.props;if(o(f))for(a in f)l[a]=J(a,f,e||Gi);else o(n.attrs)&&_e(l,n.attrs),o(n.props)&&_e(l,n.props);return s=new ge(n,l,i,r,t),c=u.render.call(null,s._c,s),c instanceof Sr&&(c.functionalContext=r,c.functionalOptions=u,n.slot&&((c.data||(c.data={})).slot=n.slot)),c}function _e(t,e){for(var n in e)t[Si(n)]=e[n]}function be(t,e,n,a,s){var u,l,f,d,p,h,v;if(!r(t)&&(u=n.$options._base,
...
function Ie(t,e,n,r,o,a){return(Array.isArray(n)||s(n))&&(o=r,r=n,n=void 0),i(a)&&(o=yo),Ae(t,e,n,r,o)}function Ae(t,e,n,r,i){var a,s,c;
...
function Oe(t){var e,n,r,o;t._vnode=null,e=t.$options,n=t.$vnode=e._parentVnode,r=n&&n.context,t.$slots=At(e._renderChildren,r),t.$scopedSlots=Gi,
// bind the createElement fn to this instance
// so that we get proper render context inside it.
// args order: tag, data, children, normalizationType, alwaysNormalize
// internal version is used by render functions compiled from templates
t._c=function(e,n,r,o){return Ie(t,e,n,r,o,!1)},
// normalization is always applied for the public version, used in
// user-written render functions.
t.$createElement=function(e,n,r,o){return Ie(t,e,n,r,o,!0)},o=n&&n.data,R(t,"$attrs",o&&o.attrs||Gi,null,!0),R(t,"$listeners",e._parentListeners||Gi,null,!0)}function Te(t){
...
t.util={warn:Ir,extend:b,mergeOptions:X,defineReactive:R},t.set=U,t.delete=B,t.nextTick=at,t.options=Object.create(null),Ui.forEach(function(e){t.options[e+"s"]=Object.create(null)}),
...
c(_,i,t,v.elm)),_=n[++p]);d>h?(f=r(n[g+1])?null:n[g+1].elm,y(t,f,n,p,g,i)):p>g&&b(t,e,d,h)}function w(t,e,n,r){var i,a;for(i=n;i<r;i++)if(a=e[i],o(a)&&gn(t,a))return i}function k(t,e,n,a){var s,c,u,l,f;if(t!==e){if(s=e.elm=t.elm,i(t.isAsyncPlaceholder))return void(o(e.asyncFactory.resolved)?A(t.elm,e,n):e.isAsyncPlaceholder=!0);
// reuse element for static trees.
// note we only do this if the vnode is cloned -
// if the new node is not cloned it means the render functions have been
// reset by the hot-reload-api and we need to do a proper re-render.
if(i(e.isStatic)&&i(t.isStatic)&&e.key===t.key&&(i(e.isCloned)||i(e.isOnce)))return void(e.componentInstance=t.componentInstance);if(u=e.data,o(u)&&o(c=u.hook)&&o(c=c.prepatch)&&c(t,e),l=t.children,f=e.children,o(u)&&v(e)){for(c=0;c<S.update.length;++c)S.update[c](t,e);o(c=u.hook)&&o(c=c.update)&&c(t,e)}r(e.text)?o(l)&&o(f)?l!==f&&C(s,l,f,n,a):o(f)?(o(t.text)&&M.setTextContent(s,""),y(s,null,f,0,f.length-1,n)):o(l)?b(s,l,0,l.length-1):o(t.text)&&M.setTextContent(s,""):t.text!==e.text&&M.setTextContent(s,e.text),o(u)&&o(c=u.hook)&&o(c=c.postpatch)&&c(t,e)}}function I(t,e,n){
...
function A(t,e,n){var r,a,s,c,u,f,d;if(i(e.isComment)&&o(e.asyncFactory))return e.elm=t,e.isAsyncPlaceholder=!0,!0;if(e.elm=t,r=e.tag,a=e.data,s=e.children,o(a)&&(o($=a.hook)&&o($=$.init)&&$(e,!0),o($=e.componentInstance)))
// child component. it should have hydrated its own tree.
return l(e,n),!0;if(o(r)){if(o(s))
// empty element, allow client to pick up and populate children
if(t.hasChildNodes())
// v-html and domProps: innerHTML
if(o($=a)&&o($=$.domProps)&&o($=$.innerHTML)){if($!==t.innerHTML)return!1}else{for(c=!0,u=t.firstChild,f=0;f<s.length;f++){if(!u||!A(u,s[f],n)){c=!1;break}u=u.nextSibling}
...
1===n.nodeType&&n.hasAttribute(Ri)&&(n.removeAttribute(Ri),s=!0),i(s)&&A(n,a,p))return I(a,p,!0),n;
...
for(O=1;O<$.fns.length;O++)$.fns[O]()}else mn(y);y=y.parent}o(g)?b(g,[n],0,0):o(n.tag)&&_(n)}return I(a,p,d),a.elm}}function xn(t,e){(t.data.directives||e.data.directives)&&Cn(t,e)}function Cn(t,e){var n,r,o,i,a=t===Bo,s=e===Bo,c=wn(t.data.directives,t.context),u=wn(e.data.directives,e.context),l=[],f=[];for(n in u)r=c[n],o=u[n],r?(
// existing directive, update
o.oldValue=r.value,In(o,"update",e,t),o.def&&o.def.componentUpdated&&f.push(o)):(
// new directive, bind
In(o,"bind",e,t),o.def&&o.def.inserted&&l.push(o));if(l.length&&(i=function(){for(var n=0;n<l.length;n++)In(l[n],"inserted",e,t)},a?ut(e.data.hook||(e.data.hook={}),"insert",i):i()),f.length&&ut(e.data.hook||(e.data.hook={}),"postpatch",function(){for(var n=0;n<f.length;n++)In(f[n],"componentUpdated",e,t)}),!a)for(n in c)u[n]||
// no longer present, unbind
In(c[n],"unbind",t,t,s)}function wn(t,e){var n,r,o=Object.create(null);if(!t)return o;for(n=0;n<t.length;n++)r=t[n],r.modifiers||(r.modifiers=Vo),o[kn(r)]=r,r.def=K(e.$options,"directives",r.name,!0);return o}function kn(t){return t.rawName||t.name+"."+Object.keys(t.modifiers||{}).join(".")}function In(t,e,n,r,o){var i=t.def&&t.def[e];if(i)try{i(n.elm,t,n,r,o)}catch(r){et(r,n.context,"directive "+t.name+" "+e+" hook")}}/*  */
function An(t,e){var n,i,a,s,c,u,l=e.componentOptions;if(!(o(l)&&l.Ctor.options.inheritAttrs===!1||r(t.data.attrs)&&r(e.data.attrs))){s=e.elm,c=t.data.attrs||{},u=e.data.attrs||{},
// clone observed objects, as the user probably wants to mutate it
o(u.__ob__)&&(u=e.data.attrs=b({},u));for(n in u)i=u[n],a=c[n],a!==i&&$n(s,n,i);
// #4391: in IE9, setting type can reset value for input[type=radio]
// #6666: IE/Edge forces progress value down to 1 before setting a max
/* istanbul ignore if */
(Yi||Xi)&&u.value!==c.value&&$n(s,"value",u.value);for(n in c)r(u[n])&&(To(n)?s.removeAttributeNS(Oo,Lo(n)):Ao(n)||s.removeAttribute(n))}}function $n(t,e,n){$o(e)?
// set attribute for blank value
// e.g. <option disabled>Select one</option>
Eo(n)?t.removeAttribute(e):(
// technically allowfullscreen is a boolean attribute for <iframe>,
// but Flash expects a value of "true" when used on <embed> tag
n="allowfullscreen"===e&&"EMBED"===t.tagName?"true":e,t.setAttribute(e,n)):Ao(e)?t.setAttribute(e,Eo(n)||"false"===n?"false":"true"):To(e)?Eo(n)?t.removeAttributeNS(Oo,Lo(e)):t.setAttributeNS(Oo,e,n):Eo(n)?t.removeAttribute(e):t.setAttribute(e,n)}/*  */
...
function Zn(t,e){var n,i,a,s,u,l,f,d,h,v,m,g,y,_,b,x,C,w,k,A,$,O,T,L,E,S,j,M,D,P,N,R,U=t.elm;if(
...
{for(i=n.css,a=n.type,s=n.enterClass,u=n.enterToClass,l=n.enterActiveClass,f=n.appearClass,d=n.appearToClass,h=n.appearActiveClass,v=n.beforeEnter,m=n.enter,g=n.afterEnter,y=n.enterCancelled,_=n.beforeAppear,b=n.appear,x=n.afterAppear,C=n.appearCancelled,w=n.duration,k=Qr,A=Qr.$vnode;A&&A.parent;)A=A.parent,k=A.context;$=!k._isMounted||!t.isRootInsert,$&&!b&&""!==b||(O=$&&f?f:s,T=$&&h?h:l,L=$&&d?d:u,E=$?_||v:v,S=$&&"function"==typeof b?b:m,j=$?x||g:g,M=$?C||y:y,D=p(c(w)?w.enter:w),P=i!==!1&&!Yi,N=er(S),R=U._enterCb=I(function(){P&&(Wn(U,L),Wn(U,T)),R.cancelled?(P&&Wn(U,O),M&&M(U)):j&&j(U),U._enterCb=null}),t.data.show||
...
t.data.show||((w.parentNode._pending||(w.parentNode._pending={}))[t.key]=t),d&&d(w),_&&(qn(w,u),qn(w,f),zn(function(){qn(w,l),Wn(w,u),C.cancelled||b||(tr(x)?setTimeout(C,x):Yn(w,s,C))})),h&&h(w,C),_||b||C())}var i,a,s,u,l,f,d,h,v,m,g,y,_,b,x,C,w=t.elm;
// call enter callback now
/* istanbul ignore if */
return o(w._enterCb)&&(w._enterCb.cancelled=!0,w._enterCb()),i=Hn(t.data.transition),r(i)?e():void(o(w._leaveCb)||1!==w.nodeType||(a=i.css,s=i.type,u=i.leaveClass,l=i.leaveToClass,f=i.leaveActiveClass,d=i.beforeLeave,h=i.leave,v=i.afterLeave,m=i.leaveCancelled,g=i.delayLeave,y=i.duration,_=a!==!1&&!Yi,b=er(h),x=p(c(y)?y.leave:y),C=w._leaveCb=I(function(){w.parentNode&&w.parentNode._pending&&(w.parentNode._pending[t.key]=null),_&&(Wn(w,l),Wn(w,f)),C.cancelled?(_&&Wn(w,u),m&&m(w)):(e(),v&&v(w)),w._leaveCb=null}),g?g(n):n()))}function tr(t){return"number"==typeof t&&!isNaN(t)}/**
...
kr="undefined"!=typeof Set&&T(Set)?Set:function(){function t(){this.set=Object.create(null)}return t.prototype.has=function t(e){return this.set[e]===!0},t.prototype.add=function t(e){this.set[e]=!0},t.prototype.clear=function t(){this.set=Object.create(null)},t}(),Ir=C,Ar=C,$r=C,Or=C,Tr=0,Lr=function t(){this.id=Tr++,this.subs=[]},Lr.prototype.addSub=function t(e){this.subs.push(e)},Lr.prototype.removeSub=function t(e){v(this.subs,e)},Lr.prototype.depend=function t(){Lr.target&&Lr.target.addDep(this)},Lr.prototype.notify=function t(){var e,n,r=this.subs.slice();for(e=0,n=r.length;e<n;e++)r[e].update()},
...
return this._leaving=!0,ut(l,"afterLeave",function(){p._leaving=!1,p.$forceUpdate()}),pr(e,r);if("in-out"===n){if(_t(o))return c;d=function(){f()},ut(a,"afterEnter",d),ut(a,"enterCancelled",d),ut(l,"delayLeave",function(t){f=t})}}return r}}},Ii=b({tag:String,moveClass:String},wi),delete Ii.mode,Ai={props:Ii,render:function t(e){var n,r,o,i,a,s,c=this.tag||this.$vnode.data.tag||"span",u=Object.create(null),l=this.prevChildren=this.children,f=this.$slots.default||[],d=this.children=[],p=dr(this);for(n=0;n<f.length;n++)r=f[n],r.tag&&null!=r.key&&0!==(r.key+"").indexOf("__vlist")&&(d.push(r),u[r.key]=r,(r.data||(r.data={})).transition=p);if(l){for(o=[],i=[],a=0;a<l.length;a++)s=l[a],s.data.transition=p,s.data.pos=s.elm.getBoundingClientRect(),u[s.key]?o.push(s):i.push(s);this.kept=e(c,null,o),this.removed=i}return e(c,null,d)},beforeUpdate:function t(){
// force removing pass
...
/* istanbul ignore if */
/* istanbul ignore if */
return!!si&&(this._hasMove?this._hasMove:(r=e.cloneNode(),e._transitionClasses&&e._transitionClasses.forEach(function(t){Vn(r,t)}),Gn(r,n),r.style.display="none",this.$el.appendChild(r),o=Xn(r),this.$el.removeChild(r),this._hasMove=o.hasTransform))}}},$i={Transition:ki,TransitionGroup:Ai},/*  */
// install platform specific utils
De.config.mustUseProp=Io,De.config.isReservedTag=Do,De.config.isReservedAttr=wo,De.config.getTagNamespace=tn,De.config.isUnknownElement=en,
...
//
//
e.default={name:"example-page",data:function t(){return{showPicker:!1,data:[{currentIndex:1,flex:3,list:["Secret","Male","Female"],onClick:this.clickOnGender,textAlign:"center",className:"row-group"}]}},methods:{clickOnGender:function t(){var e=this.$refs.smoothPicker.getCurrentIndexList();window.alert("Clicked index:"+e[0])},dataChange:function t(e,n){console.info("list",e,n)},confirm:function t(){var e=this.$refs.smoothPicker.getCurrentIndexList();window.alert("Selected: "+this.data[0].list[e[0]])}},mounted:function t(){var e=this;setTimeout(function(){e.showPicker=!0},200)}}},/* 15 */
/***/
function(t,e){t.exports={render:function(){var t=this,e=t.$createElement,n=t._self._c||e;return n("div",{staticClass:"example-page"},[n("smooth-picker",{directives:[{name:"show",rawName:"v-show",value:t.showPicker,expression:"showPicker"}],ref:"smoothPicker",attrs:{data:t.data,change:t.dataChange}}),t._v(" "),n("button",{staticClass:"button",attrs:{type:"button"},on:{click:t.confirm}},[t._v("Confirm")])],1)},staticRenderFns:[]}}]);